...
# b^*(x, n, p) = \binom{n - 1}{x - 1} \cdot p^x \cdot q^{n - x} = (n - 1)! /
# ((x - 1)!(n - x)!) \cdot p^x \cdot q^{n - x}
#   * x: number of observed successes
#   * n: number of trials
#   * p: probability of the success of 1 trial
#   * b^*(x, n, p): the negative binomial probability, that is, having x - 1
#     successes after n - 1 trials and having x successes after n trials

# Geometrical distribution
# A special case of the negative binomial distribution
# X: Number of Bernoulli trials to get a success
# X_i = \begin{cases} 1 &\text{if the } i^{th} &\text{trial is success} \\
# 0 &\text{otherwise} \end{cases}

# Geometric distribution: negative distribution where the number of successes is 1.
# g(n, p) =  q^{n - 1} \cdot p

# Example: Bob is a high school basketball player. He is a 70% free throw
# shooter, meaning his probability of making a free throw is 0.70.
